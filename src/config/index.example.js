...
module.exports = {
  site: {
    ...
    // Site endpoints
    backend: {
      productionUrl: "http://localhost:5000", //localhost do http://localhost:5000 
      developmentUrl: "http://localhost:5000",
    },
    frontend: {
      productionUrl: "http://localhost:3000", //localhost do http://localhost:3000 
  ...
  database: {
    ...
    productionMongoURI: "mongodb://localhost/casino-com", // MongoURI to use in production
  },
  ...
  authentication: {
    ...
    reCaptcha: {
      secretKey: "6LcWZY8iAAAAADarIi3jAo-rjOxIJFNVBG-Ol0w1", //localhost do 6LcWZY8iAAAAADarIi3jAo-rjOxIJFNVBG-Ol0w1 //casino do 6Lepd2UjAAAAAKMgTRyE7-AFOPkzvD6XhiA4d4VE
    },
    googleOauth: {
      clientId:
        "1050954520208-di3svepn2ier9blvb33urk62bg63easo.apps.googleusercontent.com", //if domain is casino.com leave as it is
      clientSecret: "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", //if domain is casino.com leave as it is
    },
    steam: {
      apiKey: "D133223AE8BC559B71F0EF7CFA01F2AB", // Your Steam API key //if domain is casino.com leave as it is //for localhost need probably localhost apikey
    },
  },
};
