export const site = {
  ...
  // Site endpoints
  backend: {
    productionUrl: "https://api.casino.com", //localhost do http://localhost:5000 // else if you deploy it put "https://api.casino.com"
    developmentUrl: "http://localhost:5000",
  },
  frontend: {
    productionUrl: "https://casino.com", //localhost do http://localhost:3000 // else if you deploy it put "https://casino.com"
    developmentUrl: "http://localhost:3000",
  },
  adminFrontend: {
    productionUrl: "https://admin.casino.com",
    developmentUrl: "",
  },
}
...
export const games = {
  ...
  jackpot: {
    minBetAmountLow: 1, // Min bet amount (in coins)
    maxBetAmountLow: 10, // Max bet amount (in coins)
    minBetAmountMid: 10, // Min bet amount (in coins)
    maxBetAmountMid: 150, // Max bet amount (in coins)
    minBetAmountHigh: 150, // Min bet amount (in coins)
  ...
  roulette: {
    minBetAmount: 0.1, // Min bet amount (in coins)
    maxBetAmount: 500, // Max bet amount (in coins)
    feePercentage: 0.05, // House fee percentage
...
export const blochain = {
  ...
  httpProviderApi: "https://eth-mainnet.g.alchemy.com/v2/ePrYjCy7_LtZ1C6_wL_nPAk2efezYTwr"//"http://eos.greymass.com"
}
...
export const authentication = {
  ...
  reCaptcha: {
    secretKey: "6Lf7nkgpAAAAAHZFXl20JhoBSHZXh612Uisn1fkH", //localhost do 6LcWZY8iAAAAADarIi3jAo-rjOxIJFNVBG-Ol0w1 //casino do 6Lf7nkgpAAAAAHZFXl20JhoBSHZXh612Uisn1fkH
  },
  googleOauth: {
    clientId: "927001126096-08ju7k1q8rcakbeakikqrg53ficp085j.apps.googleusercontent.com", //if domain is casino.com leave as it is
    clientSecret: "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", //if domain is casino.com leave as it is
  },
  steam: {
    apiKey: "9BFBD8DA2D37A4F6AB29DAAD3C0C3D38", // Your Steam API key //if domain is casino.com leave as it is //for localhost need probably localhost apikey
  },
  revenueId: '65ab8f6ed19ce703808382b2',
  siteWallet: 'addr1q88r5unngaphyv9mytmf7vdfwx93q7al6hxqjl5pfdhk2kxap8dtc32y5x6yneux8h7whgnwcuj9ggwf50lhk7czvxps8v3uv7'
}