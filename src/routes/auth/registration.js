...
} from  "../../controllers/ip_addresses.js";
...
let transporter = nodemailer.createTransport({
  ...
  secure: true,
  auth: {
    user: "Casino-Game-Backend@gmail.com",
  ...
  router.post("/forgot_password", async (req, res, next) => {
    try {
      ...
      let info = await transporter.sendMail({
        from: '"casino.com" <noreplyCasino-Game-Backend@gmail.com>',
        to: req.body.email,
        subject: "Security Token",
        html: `
          <div style="font-size: 18px;">
            <div>You requested a password reset on your casino.com account.</div>
            <br/>
